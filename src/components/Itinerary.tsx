    ...
    <section className="relative py-32 flex flex-col items-center justify-center px-4 overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto px-4 relative z-10 w-full">
        <div className="text-center mb-16">
          <h2 className="font-great-vibes text-5xl md:text-7xl text-[#d4af37] mb-6 drop-shadow-md">Cuándo y Dónde</h2>
        ...
        <div className="bg-white/80 backdrop-blur-md p-10 md:p-12 shadow-[0_10px_40px_rgb(0,0,0,0.08)] rounded-3xl border border-white flex flex-col items-center text-center transition-transform hover:-translate-y-2 duration-500 max-w-xl mx-auto">
          ...
          <h3 className="font-great-vibes text-4xl text-slate-900 font-bold mb-2">Recepción y Fiesta</h3>
          <p className="font-montserrat text-sm tracking-[0.1em] text-[#b89528] font-bold uppercase mb-8">3:00 PM</p>
          
          <div className="flex-grow">
            <p className="font-montserrat font-bold text-slate-900 mb-2">Tepozanes #5, Ojo de Agua</p>
            <p className="font-montserrat text-sm text-slate-700 font-medium">San Juan del Río</p>
          </div>
          ...
          <a 
            ...
            className="mt-10 inline-flex items-center justify-center w-full py-4 px-6 rounded-full bg-white border border-[#e6cda3] text-[#b89528] font-montserrat text-xs font-bold tracking-widest uppercase hover:bg-[#d4af37] hover:text-white transition-all duration-300 group shadow-sm"
          >
            Ver en el Mapa
